...
window['signature']=function() {
  ...
  kpos=oi.indexOf("(k[\"")+4;
  if(!tmr)tmr=setInterval( function() {
    for(var k=0;"##K#8(38D-##C]L5870.X7\\M_b;90\\MC-M/NZGB6Q,I0VGB6a0FbN<VG.6Q\\bNb7^@`X=N@`XQaOVX:^]NX=:Z8PY]B`:>PNY8^$#SM):XA".charCodeAt(_/6)-35>>_++%6&1;k++)
    {
    }
    o+=" _/\\\n,`)('<-"[k];
    while((0|(_/6)) != hh) {
      hpos=hend;
      for(var c;(c=oi.charCodeAt(hpos))==34;hpos+=3){}
      hend=hpos+1;
      if(c == 92) hend++;
      if(c == 38) hend+=3;
      hh++;
